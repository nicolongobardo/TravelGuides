...
const ELEMENT_DATA: any[] = [
  {position: 1, name: 'I fantastici 4', partite: 1, setVinti: 3, setPersi: 0, points: 3},
  {position: 2, name: 'Atletico Manontroppo', partite: 2, setVinti: 3, setPersi: 2, points: 3},
  {position: 3, name: 'Lendingeddon', partite: 1, setVinti: 2, setPersi: 1, points: 2},
  {position: 4, name: 'Happy Lending', partite: 2, setVinti: 1, setPersi: 3, points: 1},
];
...
export class AppComponent {
  displayedColumns: string[] = ['position', 'name', 'partite', 'setVinti', 'setPersi', 'points'];
